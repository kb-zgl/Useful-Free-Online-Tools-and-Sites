...
- [**ToolsNova** - (*100 free browser-based tools for developers, traders and analysts.  formatter, Base64 encoder, hash generator, XAU/USD pip calculator and more. No signup, 100% client-side*)](https://toolsnova.net)
...
- [**JsonToolBox** - (*Free, privacy-first JSON tools that run entirely in your browser*) - Open Source Project](https://jsontoolbox.cc/)
